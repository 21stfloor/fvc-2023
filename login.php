...
<head>
    ...
    <title>FVC | Login</title>
	<link rel="icon" type="image/x-icon" href="img/icon.ico">

    
    
</head>
<body id="bodyLogin" style="background-image: url('img/bgdog.jpg') ;">
    ...
    if($_POST){
        ...
        if($result->num_rows==1){
            ...
            if ($utype=='p'){	
                ...
                $checker = $database->query("select * from groomer where groomemail='$email' and groompassword='$password'");
                if ($checker->num_rows==1){

...
<body>
    ...
    <div class="full-height">
        ...
        <table border="0">
            <tr>
                <td width="80%">
                    ...
                    <font class="edoc-logo">FVC </font>
                    <font class="edoc-logo-sub">| Friendstars Veterinary Clinic</font>
            ...
            <tr>
                <td  colspan="3">
                    <p class="sub-text2">Pawsitively committed to your pet's health!<br>
                   Book your pet's health, one paw at a time - with our veterinary appointment system.</p>
                </td>
            </tr>
            <tr>
        ...
        <p class="sub-text2 footer-hashen">Mojica | Natividad | Magat</p>

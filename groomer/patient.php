                    ...
                    if($_POST){
                        ...
                        if(isset($_POST["filter"])){
                            if($_POST["showonly"]=='all'){
                                ...
                                $sqlmain= "select * from gappointment inner join patient on patient.pid=gappointment.pid inner join gschedule on gschedule.gscheduleid=gappointment.gscheduleid where gschedule.groomid=$userid;";
                                $selecttype="My";
                                $current="My patients Only";
                            }
                        }

            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-dashbord menu-active menu-icon-dashbord-active" >
                        <a href="gindex.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Grooming Dashboard</p></a></div></a>
                    </td>
                </tr>				
				<tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor ">
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <form action="groomers.php" method="post" class="header-search">
        
                                    <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Veterinarian name or Email" list="groomers">&nbsp;&nbsp;
                            ...
                            <td width="15%">
                                ...
                                $groomerrow = $database->query("select  * from  groomer;");
                                $gappointmentrow = $database->query("select  * from  gappointment where gappodate>='$today';");
                                $gschedulerow = $database->query("select  * from  gschedule where gscheduledate='$today';");
                            ...
                            <tr>
                                ...
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex; ">
                                        <div>
                                                <div class="h1-dashboard" >
                                                    <?php    echo $gappointmentrow ->num_rows  ?>
                                                </div><br>
                                                <div class="h3-dashboard" >
                                                    New Booking &nbsp;&nbsp;
                                                </div>
                                ...
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;padding-top:26px;padding-bottom:26px;">
                                        <div>
                                                <div class="h1-dashboard">
                                                    <?php    echo $gschedulerow ->num_rows  ?>
                                                </div><br>
                    ...
                    <td colspan="4">
                        <table width="100%" border="0" class="dashbord-tables">
                                ...
                                <td width="50%">
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            $sqlmain= "select gappointment.gappoid,gschedule.gscheduleid,gschedule.gtitle,groomer.groomname,patient.pname,gschedule.gscheduledate,gschedule.gscheduletime,gappointment.gapponum,gappointment.gappodate from gschedule inner join gappointment on gschedule.gscheduleid=gappointment.gscheduleid inner join patient on patient.pid=gappointment.pid inner join groomer on gschedule.groomid=groomer.groomid  where gschedule.gscheduledate>='$today'  and gschedule.gscheduledate<='$nextweek' order by gschedule.gscheduledate desc";
                                ...
                                <td width="50%" style="padding: 0;">
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                            $sqlmain= "select gschedule.gscheduleid,gschedule.gtitle,groomer.groomname,gschedule.gscheduledate,gschedule.gscheduletime,gschedule.gnop from gschedule inner join groomer on gschedule.groomid=groomer.groomid  where gschedule.gscheduledate>='$today' and gschedule.gscheduledate<='$nextweek' order by gschedule.gscheduledate desc"; 
                                                $result= $database->query($sqlmain);
                            ...
                            <tr>
                                <td>
                                    <center>
                                        <a href="gappointment.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Show all Appointments</button></a>
                                    </center>
                                </td>
                                <td>
                                    <center>
                                        <a href="gschedule.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Show all Sessions</button></a>
                                    </center>
                                </td>
                            </tr>
                        </table>
